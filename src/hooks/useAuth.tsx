...
export const AuthProvider = ({ children }: { children: ReactNode }) => {
  ...
  const signIn = async (identifier: string, password: string) => {
    ...
    // Admin accounts may use a friendly username while Supabase Auth continues
    // to authenticate with an email-shaped identifier under the hood.
    const email = normalized.includes("@")
      ? normalized
      : `${normalized}@admin.crazzy.local`;
