  ...
  return (
    <div>
      <div className="flex items-center justify-between">
        <div><h2 className="text-xl font-bold text-foreground">Central de Produtos</h2><p className="mt-1 text-xs text-muted-foreground">Crie, edite, organize planos e prepare a entrega sem sair deste módulo.</p></div>
          ...
          <div className="mt-4 grid gap-4 sm:grid-cols-2">
            ...
            <div className="sm:col-span-2">
              ...
              <textarea value={formDescription} onChange={(e) => setFormDescription(e.target.value.slice(0, 500))}
                ...
                rows={3}
                className="mt-1 w-full rounded-lg border border-border bg-secondary/50 px-4 py-2.5 text-sm text-foreground placeholder:text-muted-foreground outline-none focus:border-success/50 resize-y min-h-[80px]" />
            </div>
