-- CRAZZY PROJECT - REWARDS / TRIAL SYSTEM (PENDING APPLY)
-- NOT A LIVE MIGRATION YET. The local source points at conflicting Supabase project refs.
-- Convert this file into a real Supabase migration only after the production project is confirmed.
