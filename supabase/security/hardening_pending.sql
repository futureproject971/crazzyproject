-- CRAZZY PROJECT - SECURITY HARDENING (PENDING APPLY)
-- This is intentionally NOT a migration yet because this local source is not confirmed
-- to be linked to the production Supabase project. Apply only after the correct project
-- is identified, review duplicate provider IDs first, then turn this into a real migration.
